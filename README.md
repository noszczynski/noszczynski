...
Throughout the period of cooperation with Plenti considering only the number of deleted lines (which may indicate optimization and simplification), my two accounts are second to none:
